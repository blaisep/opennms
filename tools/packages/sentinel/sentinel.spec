...
"${ROOT_INST}/bin/ensure-user-ping.sh" "sentinel" >/dev/null 2>&1 || echo "Unable to enable ping by the 'sentinel' user. If you intend to run ping-related commands from the Sentinel container, try running ${ROOT_INST}/bin/ensure-user-ping.sh manually."
